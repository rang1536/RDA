				...
				<script>
				   ...
				   var table = 
				    ...
				    ajax : {
				      ...
				      "url":"${pageContext.request.contextPath }/ajax/mhEntityListDetail",
				      "type":"POST",
				    	   ...
				    	   if (json != 'null') {
				    		   ...
				    		   for(var i=0; i<farmlist.length; i++){
						   	    ...
						   	    //  	farmlist[i].phone2 =" 	<div align='center'><a href='envEntityUpdate?farmId=${farmId }''><input type='button' value='수정'></a></div>";
						   	    	      	farmlist[i].phone3 =" <div align='center'><a href='mhEntityUpdate?farmId=${farmId}&entity_id="+farmlist[i].entity_ID+"&seqno="+farmlist[i].seqno+"'><input type='button' value='수정'></a></div>";
				...
				return json.entityList
				  ...
				  columns : [
					   {data: "rnum", sClass:"counNo"},
					      {data: "entity_ID"},
					      {data: "view_totalOccDate"},
					      {data: "view_totalCurDate"},
					      {data: "disease"},
					      {data: "prescribe"},      
					      {data: "view_totalRecDate"},
// 					      {data: "feces_STATE"},
// 					      {data: "feces_COLOR"},
// 					      {data: "feces_BLOOD"},
// 					      {data: "diarrhea"},
...
<!-- 							 <input  class="btn btn-default buttons-excel buttons-html5" type="button" value="인쇄" onClick="print(document.getElementById('payList').innerHTML)"> -->
			 			 ...
			 			 <input  class="btn btn-default buttons-excel buttons-html5"  type="button" value="추가" onclick="location.href='mhEntityInsert?farmId=${farmId }&entity_id=${entity_id}'"> 
