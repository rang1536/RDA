				     			   ...
				     			   if(farmlist[i].hp3==null){ farmlist[i].hp3=""   }
						   	       ...
						   	       // phone2에 지도보기버튼 추가
						      	     	...
						      	     	farmlist[i].phone3 =" <div align='center'><a href='feserecogrecogEntityListDetail?entity_id="+farmlist[i].entity_ID+"'><input type='button' value='분석'></a></div>";
						   	    	     ...
						   	    	     //farmlist[i].phone3 =" <div align='center'><input type='button' onclick=\"window.open('fecesEntityInsert?entity_id="+encodeURI(farmlist[i].entity_ID)+"','설문조사','top=100px, left=200px, height=500px, width=500px');\" value='분석'></div>";
