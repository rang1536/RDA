...
<script>
   ...
   var table = 
    ...
    ajax : {
      ...
      "url":"${pageContext.request.contextPath }/ajax/entityList",
      "type":"POST",
    		   ...
    		   for(var i=0; i<farmlist.length; i++){
    			   ...
    			   console.log(farmlist[i].phone1);  
     			   ...
     			   if(farmlist[i].hp3==null){ farmlist[i].hp3=""   }
		   	       ...
		   	       //보기 버튼 만들기	
		   	       // phone2에 지도보기버튼 추가
		   	      	//farmlist[i].phone2 =" 	<div align='center'><a href='farmUpdate?farmId='" +farmlist[i].farmId+"><input type='button' value='보기'></a></div>";
