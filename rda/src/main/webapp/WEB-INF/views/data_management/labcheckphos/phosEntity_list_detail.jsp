				...
				<script>
				   ...
				   var table = 
				    ...
				    ajax : {
				      ...
				      "url":"${pageContext.request.contextPath }/ajax/phosEntityListDetail",
				      "type":"POST",
...
<!-- 							 <input  class="btn btn-default buttons-excel buttons-html5" type="button" value="인쇄" onClick="print(document.getElementById('payList').innerHTML)"> -->
			 			 ...
			 			 <input  class="btn btn-default buttons-excel buttons-html5"  type="button" value="추가" onclick="location.href='phosEntityInsert?farmId=${farmId }&entity_id=${entity_id}'"> 
