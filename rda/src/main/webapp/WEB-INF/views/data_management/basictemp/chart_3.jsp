...
<%
	...
	if(sel03 != "" && sel03 != null ){
		...
		//월전체뽑아내기
		SQL = "select node_id,to_char(to_date(DTIME,'yyyy-mm-dd'),'yy.mm.dd'),ROUND(AVG(ACTION_VALUE),3) from TURBOSOFT.SENSE where DEV_TYPE = '2' and ACTION_VALUE between '25'and '45' GROUP BY node_id,to_char(to_date(DTIME,'yyyy-mm-dd'),'yy.mm.dd') ORDER BY to_char(to_date(DTIME,'yyyy-mm-dd'),'yy.mm.dd') asc";
		stmt = conn.prepareStatement(SQL);
				...
				<table width="100%" >
					<tr>
						...
						%>
							...
							<td width="48" align="right"><span class="button green"><input onclick="parent.center.location.href='../sense/chart_32.jsp?sense_nodeId=<%=sense_nodeId%>&sense_cuId=<%=sense_cuId %>'" type="button" value="중앙값분석" onClick="activ()"></span></td>
						<td width="48" align="right"><span class="button blue"><input onclick="window.open('chart3_excel.jsp','엑셀','fullscreen');" type="button" value="엑셀"></span></td>
						<%-- <td width="149">
