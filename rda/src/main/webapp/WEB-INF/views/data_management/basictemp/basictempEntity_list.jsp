...
<script>
   ...
   var table = 
    ...
    ajax : {
      ...
      "url":"${pageContext.request.contextPath }/ajax/basicEntityList?sensedevtipe=2",
      "type":"POST",
    			   ...
    			   console.log(farmlist[i].phone1);  
		            ...
		            //수정 버튼만들기
		   	    	  //phone3에 수정버튼 추가
		   	    	    	...
		   	    	    	farmlist[i].phone3 =" <div align='center'><a href='basicTempEntityChart?sensecuid="+farmlist[i].sensecuid+"&sensenodeid="+farmlist[i].sensenodeid+" '><input type='button' value='보기''></a></div>";
...
<input  class="btn btn-default buttons-excel buttons-html5"  type="button" style="width:85px !important" value="체온분석" onclick="location.href='basicTempTotalChart'">
