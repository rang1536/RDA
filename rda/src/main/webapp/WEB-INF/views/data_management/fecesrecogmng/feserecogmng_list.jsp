    			   ...
    			   console.log(farmlist[i].phone1);  
		            ...
		            //수정 버튼만들기
		   	    	  //phone3에 수정버튼 추가
		   	    	    ...
		   	    	    // 	farmlist[i].phone3 =" <div align='center'><a href='feserecogmngEntityList?farmId=${list.farmId }''><input type='button' value='분석'></a></div>";
		   	    	  
		   	    	   	farmlist[i].phone3 =" <div align='center'><a href='feserecogmngEntityList?farmId="+farmlist[i].farmId+"'><input type='button' value='관리'></a></div>";
