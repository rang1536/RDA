...
=======
    ...
    <script type="text/javascript" src="https://code.jquery.com/jquery-2.2.4.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.js"></script>
>>>>>>> branch 'master' of https://github.com/rang1536/RDA.git
		            ...
		            //수정 버튼만들기
		   	    	  //phone3에 수정버튼 추가
		   	    	      ...
		   	    	      //	farmlist[i].phone3 =" <div align='center'><a href='farmUpdate?farmId=""${list.farmId }''><input type='button' value='수정'></a></div>";
		   	    	         farmlist[i].phone3 =" <div align='center'><a href='farmUpdate?farmId="+farmlist[i].farmId+"'><input type='button' value=' 수정'></a></div>";
