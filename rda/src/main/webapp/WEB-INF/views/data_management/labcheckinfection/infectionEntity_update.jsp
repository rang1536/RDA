...
function modify(){
 ...
 console.log(quresearch);
		$.ajax({
			url : "${pageContext.request.contextPath }/ajax/infectionEntityUpdateDo",
			type : "POST",
			data : quresearch,
			dataType : "json",
			success : function(data) {
...
function del() {
	if(confirm("삭제하시겠습니까?")) {
		var quresearch = $('#regForm').serialize();
		 console.log(quresearch);
				$.ajax({
					url : "${pageContext.request.contextPath }/ajax/infectionEntityDeleteDo",
					type : "POST",
					data : quresearch,
					dataType : "json",
					success : function(data) {
...
<select name="tdate" id="tdate">
    ...
    <option value="24">24시</option>
		...
		<tr>
			<th>E-coli (K99)</th>
			<td style="padding-left: 5px">
				<input type="text" name="ECOLI" id="ECOLI" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getECOLI()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Coronavirus</th>
			<td style="padding-left: 5px">
				<input type="text" name="CORONAVIRUS" id="CORONAVIRUS" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getCORONAVIRUS()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Rotavirus</th>
			<td style="padding-left: 5px">
				<input type="text" name="ROTAVIRUS" id="ROTAVIRUS" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getROTAVIRUS()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Cryptosporidium</th>
			<td style="padding-left: 5px">
				<input type="text" name="CRYPTOSPORIDIUM" id="CRYPTOSPORIDIUM" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getCRYPTOSPORIDIUM()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Giardia</th>
			<td style="padding-left: 5px">
				<input type="text" name="GIARDIA" id="GIARDIA" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getGIARDIA()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>BVD(Ag)</th>
			<td style="padding-left: 5px">
				<input type="text" name="BVDAG" id="BVDAG" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getBVDAG()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>BVD(Ab)</th>
			<td style="padding-left: 5px">
				<input type="text" name="BVDAB" id="BVDAB" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getBVDAB()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Eimeria</th>
			<td style="padding-left: 5px">
				<input type="text" name="EIMERIA" id="EIMERIA" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getEIMERIA()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>기타 병원성 세균(salmonella, CP 등)</th>
			<td style="padding-left: 5px">
				<input type="text" name="ETC" id="ETC" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getETC()}">Neg/Posi<br>
			</td>
		</tr>
		<tr>
			<th>Theileria</th>
			<td style="padding-left: 5px">
				<input type="text" name="THEILERIA" id="THEILERIA" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="${EntityList.getTHEILERIA()}">Neg/Posi<br>
			</td>
		</tr>
				<tr>
			<th>측정 장비</th>
