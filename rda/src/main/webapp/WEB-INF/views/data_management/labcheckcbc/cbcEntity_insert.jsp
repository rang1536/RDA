...
<select name="tdate" id="tdate">
    ...
    <option value="24">24시</option>
		...
		<tr>
			...
			<th>PP</th>
			<td style="padding-left: 5px">
				<input type="text" name="PP" id="PP" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="">Plasma Protein(g/dL)<br>
			</td>
<th>SP</th>
			<td style="padding-left: 5px">
				<input type="text" name="SP" id="SP" onkeyup="if ( isNaN(this.value) ) { alert('숫자만 입력가능합니다.'); this.value=''; } else { if(this.value > 999) { this.value = this.value.substring(0,4); } }" value="">Serum Protein(g/dL)<br>
			</td>
		</tr>
		<tr>
