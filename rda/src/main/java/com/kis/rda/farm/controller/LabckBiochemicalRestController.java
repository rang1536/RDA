...
@RestController				
public class LabckBiochemicalRestController {				
				
@Autowired				
private LabckBiochemicalService labckbiochemicalService;				
@RequestMapping(value = "/ajax/labckbiochemicalList", method = RequestMethod.GET)				
public Map<String,Object> ajaxlabckbiochemicalListCtrl(Model model,				
