...
@RestController				
public class LabckImmuneRestController {				
				
@Autowired				
private LabckImmuneService labckimmuneService;				
@RequestMapping(value = "/ajax/labckimmuneList", method = RequestMethod.GET)				
public Map<String,Object> ajaxlabckimmuneListCtrl(Model model,				
